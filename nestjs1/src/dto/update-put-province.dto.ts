// src/province/dto/update-put-province.dto.ts (para PUT)
import { IsNotEmpty, IsString, MaxLength, IsInt, IsLatitude, IsNumber, IsLongitude } from 'class-validator';

export class UpdatePutProvinceDto {
